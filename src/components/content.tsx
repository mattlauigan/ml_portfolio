    ...
    <section id="content">
      <div className="about">
        ...
        <p>
          ...
          offer a seamless user experience from the front end to the back end.
        </p>

        <p>
          I am passionate about building new projects and constantly expanding
          my knowledge of the latest technologies. I spend my free time learning
          through online resources, videos, and documentation, and I enjoy
